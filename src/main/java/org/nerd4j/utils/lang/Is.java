 ...
 * <ul>
 *  <li><b>NULL</b>
 *      - checks if an {@link Object} is {@code null}</li>
 *  <li><b>empty</b>
 *      - checks if a {@link String}, a {@link Collection}, a {@link Map}, an array
 *        or an implementation of the {@link Emptily} interface is empty</li>
 *  <li><b>blank</b>
 *      - checks if a {@link String} contains only characters satisfying {@link Character#isWhitespace(char)}</li>
 * </ul>
 *
 * <p>
 ...
 * <pre>
 *  collection.stream().filter( Is::NULL ) // Do something
 *
 *  or
 *
 *  optional.filter( Is::blank ) // Do something
 * </pre>
 *
